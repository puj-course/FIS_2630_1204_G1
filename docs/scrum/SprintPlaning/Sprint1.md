...
|---|---|---|---|---|---|
| **#1** | **.1:** Casos de Uso y Asignación de Roles | Laura Sofía Ortiz | 4 (L) | **Done** | Definición detallada de 13 casos de uso (CU-01 a CU-13) para Jefe de Farmacia, Auxiliar y Administrador. |
...
## 1. Información General del Sprint
* **Sprint Goal:** Sentar las bases conceptuales, técnicas y visuales del sistema CareStock, delimi>
* **Duración:** 1 semana
* **Capacidad Compromiso:** 14 Puntos de Historia (5 Hitos Unificados: #1 a #5)
* **Integrantes del Equipo:**
  * Mateo Salazar Bogotá (Product Owner)
...
| ID | Hito Unificado | Responsables | Est. (Pts) | Estado Final | Criterios de Aceptación Cumplido>
|---|---|---|---|---|---|
| **#1** | **.1:** Casos de Uso y Asignación de Roles | Laura Sofía Ortiz | 4 (L) | **Done** | Defi>
| **#2** | **.2:** Inicio de Planteamiento de Interfaz y Paleta de Colores | Valentina Carrillo | 2>
| **#3** | **.3:** Evaluación Arquitectónica de Datos | Alejandro Rodríguez, Santiago Cadena | 2 (M>
| **#4** | **.4:** Investigación de Integración e Inspección de Código | Alejandro Rodríguez, Santi>
| **#5** | **.5:** Análisis de Requerimientos y Delimitación de Alcance | Mateo Salazar Bogotá | 4 >
